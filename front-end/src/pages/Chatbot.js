...
function chatbotResponse() {
  ...
  if (lastUserMessage === "hi" || lastUserMessage === "hello" || lastUserMessage.includes('help')) {
    const hi = ["hi", "howdy", "hello", "how can I help you?"];
...
function Chatbot() {
  return (
    <div className="chatbot-container">
      <div id="bodybox">
        <div id="chatborder">
          <div id="chatscroll-container">
              {/* not dynamic - only 7 entries */}
